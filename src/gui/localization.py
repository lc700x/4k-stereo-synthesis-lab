...
MESSAGE_CATALOGS = {
    "EN": {
       ...
       "Preview":"Preview",
        ...
        "tooltip_render_policy": "Runtime render-size policy is fixed to 4K render-size tiers.",
        "tooltip_render_scale": "Target render size used only for 4K or larger input. Smaller input keeps its native size.",
    ...
    "CN": {
        ...
        "tooltip_render_policy": "运行时渲染尺寸策略固定为 4K 渲染档位。",
        "tooltip_render_scale": "仅 4K 或更高输入使用的目标渲染尺寸；低于 4K 的输入保持原生尺寸。",
