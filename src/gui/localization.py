...
MESSAGE_CATALOGS = {
    "EN": {
       ...
       "Preview":"Preview",
        ...
        "tooltip_ipd": "Physical interpupillary distance display. Internally calibrated to the runtime parallax scale.",
        "tooltip_stereo_scale": "Stereo strength multiplier applied after IPD calibration; lower values reduce parallax, higher values increase depth",
    ...
    "CN": {
        ...
        "tooltip_ipd": "物理瞳距显示值，内部会映射到适合当前视差公式的运行时尺度",
        "tooltip_stereo_scale": "IPD 标定后的立体强度倍率；数值越低视差越小，数值越高深度越强",
        "tooltip_device": "计算设备",
