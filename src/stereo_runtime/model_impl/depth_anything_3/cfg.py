...
# Allow "import depth_anything_3" to resolve from stereo_runtime.model_impl
...
def import_item(path: str, name: str) -> Any:
    ...
    try:
        ...
        # HuggingFace configs use "depth_anything_3.*"; remap to the bundled implementation package.
        if path.startswith("depth_anything_3"):
            return getattr(importlib.import_module("stereo_runtime.model_impl." + path), name)
        raise
